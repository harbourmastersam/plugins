...
class ServerLifecycleState extends Model
{
    ...
    protected function casts(): array { return ['automatic_enabled' => 'boolean', 'last_activity_at' => 'immutable_datetime', 'archive_due_at' => 'immutable_datetime', 'exempt_until' => 'immutable_datetime', 'status' => LifecycleStatus::class]; }
