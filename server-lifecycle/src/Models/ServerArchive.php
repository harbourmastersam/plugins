...
class ServerArchive extends Model
{
    ...
    {
        return ['status' => LifecycleStatus::class, 'manifest' => 'encrypted:array', 'policy_snapshot' => 'array', 'original_node' => 'array', 'original_allocations' => 'array', 'archive_started_at' => 'immutable_datetime', 'activity_snapshot_at' => 'immutable_datetime', 'archived_at' => 'immutable_datetime', 'retention_expires_at' => 'immutable_datetime', 'pending_deletion_at' => 'immutable_datetime', 'final_delivery_sent_at' => 'immutable_datetime', 'final_delivery_expires_at' => 'immutable_datetime', 'restored_at' => 'immutable_datetime', 'remote_object_deleted_at' => 'immutable_datetime', 'retry_after' => 'immutable_datetime'];
    }
